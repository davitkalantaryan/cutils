...
CPPUTILS_UTEST_ALL(f_0002_fourstate_flags, t_0001) {
	...
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_ongoing_false_to_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_ongoing_true_to_false == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_false == 1);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_ongoing_false_to_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_ongoing_true_to_false == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_false == 1);

	aFlags.wr.field1 = CPPUTILS_FOURSTATE_MAKE_BITS_TRUE;
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_true == 1);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_ongoing_false_to_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_ongoing_true_to_false == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_false == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_ongoing_false_to_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_ongoing_true_to_false == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_false == 1);
	...
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_ongoing_false_to_true == 1);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_ongoing_true_to_false == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_false == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_ongoing_false_to_true == 0);
	...
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_ongoing_false_to_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_ongoing_true_to_false == 1);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_false == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_ongoing_false_to_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_ongoing_true_to_false == 0);
	...
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_ongoing_true_to_false == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_false == 1);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_true == 1);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_ongoing_false_to_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_ongoing_true_to_false == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_false == 0);
	...
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field1_false == 1);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_ongoing_false_to_true == 1);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_ongoing_true_to_false == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_false == 0);
	...
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_ongoing_false_to_true == 0);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_ongoing_true_to_false == 1);
	CinternalUnitTestAssertCheckOpt(aFlags.rd1.field2_false == 0);
